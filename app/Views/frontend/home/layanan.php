<!-- Membership Section -->
<section id="membership" class="py-16 hero-pattern2 text-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold mb-4">Layanan dan Program</h2>
            <p class="max-w-2xl mx-auto text-pumpkin-100">Melalui layanan dan program ini, perpustakaan menjadi pusat belajar yang dinamis, inovatif, dan berperan aktif dalam membentuk generasi literat dan kreatif.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-lg text-gray-800 transform scale-105 z-10">
                <div class="p-6 bg-pumpkin-600 text-white">
                    <div class="flex justify-between items-center mb-2">
                        <h3 class="text-xl font-bold">PROGRAM PERPUSTAKAAN</h3>
                    </div>
                    <p class="text-pumpkin-100 text-sm">Great for regular library users.</p>
                </div>
                <div class="p-2">
                    <?php
                    $kegiatan = [
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
                        <?php foreach ($kegiatan as $item): ?>
                            <div class="bg-white rounded-lg overflow-hidden shadow-lg text-gray-800 transition-transform hover:-translate-y-2 duration-300">
                                <div class="p-6 bg-saddle-50 text-center">
                                    <!-- Ikon besar -->
                                    <div class="flex justify-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-pumpkin-600" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-lg text-gray-800 transition-transform hover:-translate-y-2 duration-300">
                ...
                <div class="py-6 px-4 bg-saddle-50">
