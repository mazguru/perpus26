                    ...
                    <div class="p-4">
                        <div class="mb-[5px]">
                            <ul class="flex flex-wrap">
                                <li class="uppercase text-sm mr-5 text-black flex items-center gap-x-[0.3rem]"><i class="bi bi-user-circle text-primary"></i> By <a class="text-primary ltr:ml-[3px] rtl:mr-[3px]" href="javascript:void(0);">Johne Doe</a></li>
                                <li class="uppercase text-sm mr-5 text-black flex items-center gap-x-[0.3rem]"><i class="bi bi-comment text-primary"></i> <a class="text-primary ltr:ml-[3px] rtl:mr-[3px]" href="javascript:void(0);">15 Comments</a></li>
                            </ul>
                        </div>
                        <h4 class="mb-[5px] leading-[1.3]"><a href="blog-details-1.html"><?= esc($a['post_title']) ?></a></h4>
                        <p class="mb-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        <div class="mt-4 flex items-center">
                            <span class="text-sm text-gray-500">12 Mei 2023</span>
                            <a href="/post/<?= $a['post_slug'] ?>" class="ml-auto py-5 px-[35px] max-xl:py-3 max-xl:px-[25px] text-[15px] max-xl:text-sm inline-block font-medium leading-[1.2] uppercase bg-primary hover:bg-primaryhover text-white rounded duration-700">Baca selengkapnya</a>
                        </div>
                    </div>
