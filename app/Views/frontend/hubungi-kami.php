...
<section class="bg-blue-700 text-white py-16">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl max-w-2xl mx-auto text-blue-100">Kami siap membantu Anda. Jangan ragu untuk menghubungi kami dengan pertanyaan, saran, atau kebutuhan informasi lainnya.</p>
    </div>
</section>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="contact-card bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg shadow-md text-center">
                <div class="bg-blue-600 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                </div>
                <h3 class="text-xl font-semibold text-blue-800 mb-2">Telepon</h3>
                <p class="text-gray-600 mb-4">Senin - Jumat: 08.00 - 16.00</p>
                <a href="tel:+6221123456789" class="text-blue-600 font-medium hover:text-blue-800 transition"><?= session('phone') ?></a>
            </div>
            ...
            <div class="contact-card bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg shadow-md text-center">
                ...
                <h3 class="text-xl font-semibold text-blue-800 mb-2">Email</h3>
                <p class="text-gray-600 mb-4">Respon dalam 24 jam</p>
                <a href="mailto:info@perpustakaandigital.id" class="text-blue-600 font-medium hover:text-blue-800 transition"><?= session('email') ?></a>
            </div>
            ...
            <div class="contact-card bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg shadow-md text-center">
                ...
                <address class="not-italic text-blue-600">
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12" x-data="formMessage">
            ...
            <!-- Map -->
            <div>
                <h2 class="text-2xl font-bold text-blue-800 mb-6">Lokasi Kami</h2>
                ...
                <div class="mt-8 bg-blue-50 p-6 rounded-lg border border-blue-100">
                    <h3 class="text-lg font-semibold text-blue-800 mb-3">Jam Operasional</h3>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-blue-800 text-center mb-12">Pertanyaan yang Sering Diajukan</h2>
        <div class="max-w-3xl mx-auto space-y-6">
            <div class="bg-blue-50 rounded-lg overflow-hidden shadow-md">
                <button class="faq-toggle w-full flex justify-between items-center p-5 text-left focus:outline-none" onclick="toggleFAQ(this)">
                    <span class="font-medium text-blue-800">Bagaimana cara menjadi anggota perpustakaan?</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-blue-50 rounded-lg overflow-hidden shadow-md">
                <button class="faq-toggle w-full flex justify-between items-center p-5 text-left focus:outline-none" onclick="toggleFAQ(this)">
                    <span class="font-medium text-blue-800">Berapa lama masa peminjaman buku?</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
            ...
            <div class="bg-blue-50 rounded-lg overflow-hidden shadow-md">
                <button class="faq-toggle w-full flex justify-between items-center p-5 text-left focus:outline-none" onclick="toggleFAQ(this)">
                    <span class="font-medium text-blue-800">Apakah perpustakaan menyediakan akses e-book?</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
            ...
            <div class="bg-blue-50 rounded-lg overflow-hidden shadow-md">
                <button class="faq-toggle w-full flex justify-between items-center p-5 text-left focus:outline-none" onclick="toggleFAQ(this)">
                    <span class="font-medium text-blue-800">Bagaimana cara memesan ruang diskusi?</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
