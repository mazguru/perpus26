<article class="bg-white rounded-lg shadow-md p-6 mb-8">
  ...
  <div class="mb-6 rounded-lg overflow-hidden bg-saddle-100">
    <?php
  ...
  <div class="flex items-center mt-8 pt-6 border-t border-gray-200">
    ...
    <div class="flex space-x-2">
      <button onclick="shareOnFacebook()" class="p-2 bg-pumpkin-600 text-white rounded-full hover:bg-pumpkin-700 transition">
      ...
      <button onclick="shareOnLinkedIn()" class="p-2 bg-pumpkin-700 text-white rounded-full hover:bg-pumpkin-800 transition">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <button onclick="shareByEmail()" class="p-2 bg-saddle-600 text-white rounded-full hover:bg-saddle-700 transition">
