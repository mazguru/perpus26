  ...
  <header class="sticky top-0 z-50 bg-white shadow">
    <div class="container mx-auto px-4 py-3 flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        <h1 class="text-xl font-semibold text-green-800">Perpustakaan Ulil Albab</h1>
      </div>
      <nav class="hidden md:flex gap-6 text-sm font-medium text-gray-700">
        ...
        <div class="relative group">
          ...
          <div class="absolute left-0 mt-1 w-40 bg-white shadow-lg hidden group-hover:block">
...
<header
    ...
    class="sticky top-0 z-10 flex w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900">
    <div
        ...
        <div
            ...
            <button
                ...
                class="z-10 flex h-10 w-10 items-center justify-center rounded-lg border-gray-200 text-gray-500 lg:h-11 lg:w-11 lg:border dark:border-gray-800 dark:text-gray-400"
            ...
            <button
                class="z-10 flex h-10 w-10 items-center justify-center rounded-lg text-gray-700 hover:bg-gray-100 lg:hidden dark:text-gray-400 dark:hover:bg-gray-800"
        ...
        <div
            ...
            <div
                ...
                <a
                    ...
                    <span class="text-theme-sm mr-1 block font-medium"> <?= esc(session('user_full_name') ?? 'Tamu'); ?> </span>
