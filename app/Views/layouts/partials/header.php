    ...
    <div class="max-w-screen-xl mx-auto flex flex-wrap justify-between items-center px-4 pt-2">
        <div class="hidden md:flex items-center space-x-3">
            ...
            <div class="text-white">
                <h1 class="text-base md:text-lg font-bold my-0 py-0">PERPUSTAKAAN ADYATAMA</h1>
                <p class="text-xs text-gray-200 my-0 py-0">SMP Islam Al Azhar 26 Yogyakarta<br>NPP. 3404061D0100001</p>
            </div>
        </div>
        <!-- Desktop -->
