            ...
            <div class="bg-white rounded-xl p-6 w-full max-w-lg">
                ...
                <form @submit.prevent="submitForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea x-model="form.caption" class="w-full border rounded px-3 py-2" row="5"></textarea>
                    </div>

                    <div class="mb-4">
                        <label class="block text-xs font-semibold mb-1">Target Link</label>
                        <input type="text" x-model="form.link" class="w-full border rounded px-3 py-2 bg-gray-100">
                    </div>
