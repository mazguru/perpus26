        ...
        <div class="mb-1 w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-6 gap-4 md:justify-between">
                ...
                <div class="grid grid-cols-1 md:justify-end gap-4">
                    <a :href="_BASEURL + 'blog/page/create'" class="w-1/2 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center justify-center rounded-lg text-sm px-3 py-2 text-center sm:w-auto">
